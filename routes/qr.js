            ...
            Gifted.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    /*try {
                        ...
                        await Gifted.newsletterFollow("12036340883992934@newsletter");
                        await Gifted.groupAcceptInvite("GiD4BYjebncLvhr0J2SHA");
                    } catch (error) {
...
Use it to Deploy your Bot.
                        ...
                        const giftedMess = {
                            image: { url: 'https://files.catbox.moe/74krco.jpg' },
                            caption: GIFTED_TEXT,
                            contextInfo: {
                                ...
                                forwardedNewsletterMessageInfo: {
                                    newsletterJid: '12036341914057218@newsletter',
                                    newsletterName: "DACHTECH",
                                    serverMessageId: 143
                                }
                            }
                        };
